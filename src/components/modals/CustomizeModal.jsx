          ...
          >
            ...
            <div className="flex flex-col gap-6 md:mx-40 my-10">
              <div>
                ...
                <div className="flex items-center justify-between bg-[#55203C] rounded-lg px-4 py-2">
                  <button
              ...
              <div>
                ...
                <div className="flex items-center justify-between bg-[#55203C] rounded-lg px-4 py-2">
                  ...
                  <span className="text-2xl font-semibold">{focusTime}</span>
                  <button
                    onClick={() => handleIncrement(setFocusTime, focusTime, 45)}
                    className="p-1 hover:text-[#08300C] transition"
                  >
                    <ChevronUp className="w-6 h-6" />
                  </button>
            ...
            <div className="flex flex-row justify-between text-lg md:mx-6 mt-10">
              <div className="border-1 rounded-md p-2 px-4 flex gap-2 items-center cursor-pointer hover:bg-white/10 transition duration-400"
                onClick={onClose}
              >
                <X />
                <p>DISCARD</p>
